...
export default class ScrollableTabBar extends Component {
  ...
  updateTabPanel(position, pageOffset) {
    ...
    let newScrollX = tabOffset + absolutePageOffset - (WINDOW_WIDTH / 3)
  ...
  updateTabUnderline(position, pageOffset, tabCount) {
    ...
    if (position < tabCount - 1) {
      ...
      const newLineLeft = (pageOffset * nextTabLeft + (1 - pageOffset) * lineLeft) - (WINDOW_WIDTH / 3)
      const newLineRight = (pageOffset * nextTabRight + (1 - pageOffset) * lineRight) - (WINDOW_WIDTH / 3)
